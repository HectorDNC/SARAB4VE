...
-- ---------------------------------------------------------------------------
-- Nota: help_requests.user_id (agregada arriba, junto a su índice) cubre dos
-- casos — se llena solo al crear la solicitud si quien la envía ya tiene
-- sesión (POST /api/help-requests con optionalAuthenticate), o después vía
-- POST /:id/link-account cuando la solicitud se envió sin login y la persona
-- se registra más tarde (ver helpRequests.repository.js#linkRequesterUser).
-- ---------------------------------------------------------------------------
